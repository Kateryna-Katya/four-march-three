    ...
    <section class="pages">
        <div class="container">
            ...
            <p data-aos="fade-up">
                ...
                управлять в соответствии с законодательством Великобритании и ЕС.
            </p>
            ...
            <ul data-aos="fade-up">
                ...
                <li>
                    ...
                    используют наш сайт, помогая нам улучшать контент нашего блога и анализировать востребованность консалтинговых стратегий.
                </li>
                <li>
                ...
                <li>
                    ...
                    используются для доставки объявлений, соответствующих вашим интересам и потребностям вашего бизнеса.
                </li>
            </ul>
            ...
            <ul data-aos="fade-up">
                ...
                <li>Персонализация контента и настроек для удобства пользователей в Европе и Великобритании.</li>
            ...
            <p data-aos="fade-up">
                ...
                момент изменить свои настройки в браузере или через наш Cookie-баннер. Однако, обратите
            ...
            <p data-aos="fade-up">
                ...
                сторонних компаний, например, Google Analytics для аналитики или Anime.js для визуализаций интерфейса. 
            ...
            <p data-aos="fade-up">
                ...
                законодательстве Великобритании (UK GDPR). Продолжение использования нашего сайта будет означать ваше согласие с ними.
            </p>
